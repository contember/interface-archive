...
export interface TypedEntitySelection<TSchema extends SchemaTypeLike, TEntityName extends string, TEntity extends EntityTypeLike, TValue> {
	...
	>(
		...
		[key in TAlias extends null ? TKey : TAlias]: TypedEntitySelectionResult<TEntity, TKey>
	}>
}
...
export type TypedEntitySelectionResult<TEntity extends EntityTypeLike, TKey extends string> =
	TKey extends keyof TEntity['columns'] ? TEntity['columns'][TKey]
		: TKey extends keyof TEntity['hasMany'] ? TEntity['hasMany'][TKey][]
			: TKey extends keyof TEntity['hasManyBy'] ? null | TEntity['hasManyBy'][TKey]['entity']
				: TKey extends keyof TEntity['hasOne'] ? null | TEntity['hasOne'][TKey]['entity']
					: never
