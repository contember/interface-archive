import { ColorSchemeProvider, getThemeClassName, useThemedClassName } from '@contember/react-utils'
...
import { toSchemeClass, toStateClass, toViewClass } from '../../utils'
	...
	return (
		<ColorSchemeProvider scheme={scheme}>
			...
			>
				...
				<PortalProvider>
					<DialogProvider>
						<div className={componentClassName('body', useThemedClassName([
							getThemeClassName(pageThemeContent ?? pageTheme, pageThemeControls ?? pageTheme),
