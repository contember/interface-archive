...
export const DevBar = ({ children }: { children: ReactNode }) => {
	...
	return (
		<div className={prefix + 'devBar'}>
			<a className={prefix + 'devBar-brand'} href={'https://docs.contember.com/'} target={'_blank'} rel="noreferrer">
			...
			<div className={`${prefix}devBar-panels`}>
				{children}
			</div>
			<div className={`${prefix}devBar-close`} onClick={() => setClosed(true)}>
...
export const DevPanel = ({ heading, children, preview }: {
	...
	const prefix = useClassNamePrefix()
	return (
		<div className={`${prefix}devBar-trigger`}>
			<div className={`${prefix}devBar-trigger-label`}>
				{preview ?? heading}
			</div>
			<div className={'cui-devBar-panel'}>
				<h1 className={'cui-devBar-panel-heading'}>
					{heading}
				</h1>
				<div className={'cui-devBar-panel-content'}>
					{children}
				</div>
			</div>
		</div>
