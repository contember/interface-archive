...
export const [RegistryContext, useRegistryContext] = createNonNullableContextFactory<Directives_RegistryContextType<Record<string, unknown>>>('Interface.Directives.RegistryContext', {
	register: undefined,
