...
export type Directives_ComponentProps<T> = { [K in keyof T]: { name: K, content: T[K] } }[keyof T]

export interface Directives_ComponentType<
	T extends Record<string, unknown> = Record<string, unknown>,
> extends React.ExoticComponent<Directives_ComponentProps<RequiredDeepPlainObject<T>>> {
...
export const Directive: Directives_ComponentType<RequiredDeepPlainObject> = memo<Directives_ComponentProps<Record<string, unknown>>>(({ name, content }) => {
