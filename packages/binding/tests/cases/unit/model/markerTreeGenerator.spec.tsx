...
describe('Marker tree generator', () => {
	...
	it('combine nested markers', () => {
		...
		const outerHasManyEnv = subTreeEnv.withSubtreeChild('hasMany')
		const hasOneEnv = outerHasManyEnv.withSubtreeChild('hasOne')
		const innerHasManyEnv = hasOneEnv.withSubtreeChild('common')
