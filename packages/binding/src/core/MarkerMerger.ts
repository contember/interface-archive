...
export class MarkerMerger {
	...
	public static mergeFieldMarkers(original: FieldMarker, fresh: FieldMarker) {
		...
		if (original.defaultValue !== undefined && fresh.defaultValue !== undefined && original.defaultValue !== fresh.defaultValue) {
			console.warn(`MarkerTreeGenerator merging: multiple fields "${original.fieldName}" with different defaultValue found:`, original.defaultValue, fresh.defaultValue)
		}
