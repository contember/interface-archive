...
import { CommonSlots, LayoutSlotsProvider, PropsWithRequiredChildren, useEvent } from '@contember/cms-layout'
	...
	return (
		<LayoutSlotsProvider>
			...
			<div style={{ position: 'fixed', bottom: 0, right: 0, zIndex: 1000 }}>
				<select value={typeState} onChange={useEvent((e: ChangeEvent<HTMLSelectElement>) => setTypeState(e.target.value as keyof typeof Layouts))}>
