...
export const LayoutComponent = ({ children, ...rest }: PropsWithChildren<LayoutComponentProps>) => {
	...
	return (
			...
			header={
				<>
					<LayoutKit.Header
						...
						center={state => (
							state.panels.get(LayoutKit.SidebarLeft.NAME)?.behavior !== 'modal' && createSlotTargets(['Navigation', 'HeaderCenter'])
						) || false}
		...
		>
			...
			{createSlotTargets(['SidebarRightHeader', 'SidebarRightBody', 'SidebarRightFooter'], (
