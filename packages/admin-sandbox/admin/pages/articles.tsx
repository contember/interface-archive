...
export const list = () => (
	<>
		...
		<Slots.HeaderActions><LinkButton to="articles/create">Add article</LinkButton></Slots.HeaderActions>
		<Slots.Content>
			<DataGridScope
				entities="Article"
				itemsPerPage={20}
	...
	<>
		...
		<Slots.Content>
			<MultiEditScope entities="Category" listProps={{
				sortableBy: 'order',
				beforeContent: <Slots.HeaderActions><PersistButton /></Slots.HeaderActions>,
			}}>
				<CategoryForm />
			</MultiEditScope>
		</Slots.Content>
...
export const tags = () => (
	<>
		...
		<Slots.Content>
			<MultiEditScope entities="Tag" listProps={{ beforeContent: <Slots.HeaderActions><PersistButton /></Slots.HeaderActions> }}>
